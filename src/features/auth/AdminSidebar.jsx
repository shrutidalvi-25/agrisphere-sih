...
import { LogOut, LayoutDashboard, ShieldCheck, Flag, X } from 'lucide-react'

const NAV_ITEMS = [
  { icon: LayoutDashboard, label: 'Dashboard', to: '/' },
  { icon: ShieldCheck, label: 'Verification Queue', to: '/admin/verify' },
  ...
  return (
    <div className="flex flex-col h-full bg-primary-700 w-full">
      <div className="px-5 pt-7 pb-6 text-center border-b border-white/10">
        ...
        <p className="text-primary-200 text-xs mt-0.5">Admin</p>
      </div>
...
export function AdminSidebar({ name, onSignOut, mobileOpen, onCloseMobile }) {
  return (
    <>
