...
import { LogOut, LayoutDashboard, ShoppingCart, Handshake, Wallet, Flag, X } from 'lucide-react'

const NAV_ITEMS = [
  { icon: LayoutDashboard, label: 'Dashboard', to: '/' },
  { icon: ShoppingCart, label: 'Browse Lots', to: '/buy/browse' },
  { icon: Handshake, label: 'My Offers', to: '/buy/offers' },
  ...
  return (
    <div className="flex flex-col h-full bg-primary-700 w-full">
      <div className="px-5 pt-7 pb-6 text-center border-b border-white/10">
        ...
        <p className="text-primary-200 text-xs mt-0.5">Buyer / Processor</p>
      </div>
...
export function BuyerSidebar({ name, onSignOut, mobileOpen, onCloseMobile }) {
  return (
    <>
